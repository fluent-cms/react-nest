...
import { SelectInputInForm } from "./SelectInputInForm"
...
export const ModelForm = ({ upsertState, item, display, formRef }: { upsertState: UpsertState, item: any, display: ModelDisplayOption<MyBaseEntity>, formRef: any }) => {
